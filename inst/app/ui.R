...
ui <- fluidPage(
  ...
  tags$head(
    ...
    tags$style(HTML("
      ...
      /* 1) Barre latérale noire / bleu Sphinx */
      .wy-nav-side { width: 300px; background: #343131; color: #b3b3b3; flex-shrink: 0; position: fixed; height: 100vh; }
      .wy-side-nav-search { background: #2980B9; padding: 20px 15px; text-align: left; }
      .wy-side-nav-search a { color: white; font-weight: bold; font-size: 15px; text-decoration: none; word-wrap: break-word; line-height: 1.3; }
      .wy-side-nav-search .version { color: rgba(255,255,255,0.6); font-size: 11px; margin-top: 5px; }
      
      /* 4) Liens de navigation de la sidebar style Sphinx */
      .wy-menu-vertical { padding-top: 10px; }
      .wy-menu-vertical p.caption { color: #555; background: #262424; padding: 5px 20px; margin: 0; font-size: 11px; font-weight: bold; text-transform: uppercase; letter-spacing: 1px; }
  ...
  div(class = "wy-grid-for-nav",
      ...
      # PAGE PRINCIPALE (CONTENU D'ORIGINE AVEC LE WELLPANEL)
